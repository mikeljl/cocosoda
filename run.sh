...
couninue_pre_train_data_files='toy_dataset/java/train.jsonl toy_dataset/javascript/train.jsonl  toy_dataset/python/train.jsonl  toy_dataset/php/train.jsonl  toy_dataset/go/train.jsonl toy_dataset/ruby/train.jsonl'
CUDA_VISIBLE_DEVICES=0
base_model=unixcoder

function continue_pre_train () {
output_dir=./delete/cocosoda/
mkdir -p $output_dir
echo ${output_dir}
