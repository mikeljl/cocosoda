...
code_length=256
nl_length=128
model_type=multi-loss-cocosoda #"base", "cocosoda" ,"multi-loss-cocosoda"
moco_k=1024
moco_m=0.999
lr=2e-5
moco_t=0.07
...
languages=("ruby" "java" "go" "python" "php" "javascript")
#loop through each language and run the zero-shot function
